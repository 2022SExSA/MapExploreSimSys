...
{
     MESSSimulationWidget *w = new MESSSimulationWidget(http_num);
...
{
    StatisticsWidget *w = new StatisticsWidget(websocket_num);
...
{
    ExperimentDemandWidget *w = new ExperimentDemandWidget(http_num);
